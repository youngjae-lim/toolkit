...
// PushJSONToRemote posts arbitrary data to some URL as JSON, and returns the response, status
// code, and error, if any. The final parameter, client, is optional. If non is specified,
// we use the standard http.Client.
